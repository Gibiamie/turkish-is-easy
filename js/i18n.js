...
const DICT = {
  en: {
    ...
    layaGuide: 'Laya guide', learnWhy: 'Learn why', keyRule: 'Key idea', whatHear: 'What should I hear?', mouthTip: 'Mouth / sound tip', commonMistake: 'Common mistake', miniPractice: 'Mini practice', contrast: 'Contrast',
  ...
  id: {
    ...
    layaGuide: 'Panduan Laya', learnWhy: 'Pelajari alasannya', keyRule: 'Ide utama', whatHear: 'Apa yang perlu didengar?', mouthTip: 'Petunjuk mulut / bunyi', commonMistake: 'Kesalahan umum', miniPractice: 'Latihan kecil', contrast: 'Perbandingan',

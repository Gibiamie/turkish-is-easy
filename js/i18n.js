...
const DICT = {
  en: {
    ...
    item: 'Item', of: 'of', previous: 'Previous', next: 'Next', finishTopic: 'Finish topic', mainPage: 'Main page',
    listen: 'Listen', mainSound: 'Main sound', exampleWord: 'Example word', contrastSound: 'Contrast sound',
    extraExample: 'Extra example', practiceDone: 'Practice done', alreadyKnow: 'I already know this', needsMorePractice: 'Needs more practice',
    ...
    answerHere: 'Build your answer here', clear: 'Clear', check: 'Check',
  ...
  id: {
    ...
    item: 'Nomor', of: 'dari', previous: 'Sebelumnya', next: 'Berikutnya', finishTopic: 'Selesai', mainPage: 'Beranda',
    listen: 'Dengarkan', mainSound: 'Bunyi utama', exampleWord: 'Contoh kata', contrastSound: 'Bunyi pembanding',
    extraExample: 'Contoh lain', practiceDone: 'Latihan selesai', alreadyKnow: 'Saya sudah tahu', needsMorePractice: 'Perlu latihan lagi',
    ...
    answerHere: 'Susun jawaban di sini', clear: 'Hapus', check: 'Periksa',
